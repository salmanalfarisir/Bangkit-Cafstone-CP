...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at libraries
     */
    ...
    public static class LibrariesLibraryAccessors extends SubDependencyFactory {
        ...
        public LibrariesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getPlaces() {
                return create("libraries.places");
        }
    ...
    public static class PlayLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public PlayServiceLibraryAccessors getService() {
            return laccForPlayServiceLibraryAccessors;
        }
    ...
    public static class PlayServiceLibraryAccessors extends SubDependencyFactory {
        ...
        public PlayServiceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getMaps() {
                return create("play.service.maps");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: playservicemaps (18.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPlayservicemaps() { return getVersion("playservicemaps"); }
