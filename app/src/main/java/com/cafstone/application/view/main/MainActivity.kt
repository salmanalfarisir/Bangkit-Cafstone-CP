...
class MainActivity : AppCompatActivity() {
    ...
    fun searchtext (text : String){
        ...
        val searchByTextRequest : SearchByTextRequest = SearchByTextRequest.builder(text, placeFields)
        ...
        placesClient.searchByText(searchByTextRequest)
            .addOnSuccessListener { response: SearchByTextResponse ->
                ...
                for (place in places) {
                    ...
                    placesList.add(adaptermodel(place.id, place.name,place.address?:"Unknown",photoUrl))
                }
