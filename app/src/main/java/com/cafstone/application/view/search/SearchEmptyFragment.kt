...
class SearchEmptyFragment : Fragment() {
    ...
    private val title = listOf("Indonesia Restaurant","Chinese Restaurant","American Restaurant",
        "Italian Restaurant","Korea Restaurant","Japanese Restaurant","Thailand Restaurant",
        "India Restaurant","Fast Food Rastaurant","Vegetarian Restaurant","Steak House",
        "Coffee Shop")
    private val desc = listOf("Makanan Indonesia","Makanan Cina","Makanan Amerika",
    ...
    private val image = listOf(R.drawable.indonesian_food,R.drawable.chinese_food,R.drawable.american_food,
        R.drawable.italian_food,R.drawable.korean_food,R.drawable.japanse_food,R.drawable.thai_food,
        R.drawable.indian_food,R.drawable.fast_food,R.drawable.vegetarian_food,R.drawable.steak_house,
        R.drawable.coffee_shop)
    private val isi = listOf("indonesian_restaurant","chinese_restaurant", "american_restaurant",
    ...
    override fun onCreateView(
        ...
        button = listOf(binding.indonesianFoodCard,binding.chineseFoodCard,binding.americanFoodCard,
            binding.italianFoodCard,binding.koreanFoodCard,binding.japaneseFoodCard,binding.thaiFoodCard,
            binding.indianFoodCard,binding.fastFoodCard,binding.vegetarianFood,binding.steakHouseFoodCard,
    ...
    fun setbutton (activity: SearchViewActivity,data:NearbyModel)
    {
